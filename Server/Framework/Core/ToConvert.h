...
{
public:
	static T Cast(DefString& str) { return T; }
	static T Cast(const char* value) { return T; }
	static T Cast(DefWString& value) { return T; }
	static T Cast(const wchar_t* value) { return T; }
};
...
public:
	...
	{
		char* buffer = nullptr;
		return static_cast<Int8>(strtoul(value, &buffer, 10));
	}
	...
	{
		wchar_t* buffer = nullptr;
		return static_cast<Int8>(wcstoul(value, &buffer, 10));
	}
};
